    ...
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ marginLeft: '240px', flex: 1, padding: '30px', backgroundColor: 'var(--light)', minHeight: '100vh' }}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <h3 style={{ color: 'var(--primary)', fontWeight: 'bold' }}>Manage Users</h3>
            <p style={{ color: 'var(--text-light)' }}>{users.length} users total</p>
          </div>
        </div>
                    ...
                    <tr key={u._id}>
                      ...
                      <td>
                        <span className="badge" style={{
                          backgroundColor:
                            u.role === 'LANDLORD' ? 'var(--accent)' :
                            u.role === 'RENT' ? '#17a2b8' : '#6f42c1'
                        }}>
                          {u.role}
                        </span>
                      </td>
                      ...
                      <td>
                        {u.role === 'LANDLORD' && (
                          <span className="badge" style={{
                            backgroundColor: u.isVerified ? '#28a745' : 'var(--text-light)'
                          }}>
                        ...
                        <div className="d-flex gap-2 align-items-center">
                          ...
                          {u.role === 'LANDLORD' && (
                            <button
                              ...
                              <FaShieldAlt color={u.isVerified ? '#28a745' : 'var(--text-light)'} size={16} />
                            </button>
                          )}
