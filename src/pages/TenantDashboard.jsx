    ...
    <div>
      ...
      <div className="p-4 mb-4" style={{ backgroundColor: 'var(--primary)', borderRadius: '12px' }}>
        ...
        <p className="mb-0" style={{ color: 'var(--white)' }}>
          Find your perfect rental home across Nigeria
        </p>
      </div>
      ...
      <div className="row mb-4">
        <div className="col-md-4">
          <div className="card p-3 text-center shadow-sm" style={{ borderRadius: '12px', border: 'none' }}>
            ...
            <p style={{ color: 'var(--text-light)' }}>Available Rentals</p>
          </div>
        </div>
        <div className="col-md-4">
          <div className="card p-3 text-center shadow-sm" style={{ borderRadius: '12px', border: 'none' }}>
        ...
        <div className="col-md-6">
          <Link
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-light)', marginBottom: '0', fontSize: '0.85rem' }}>Search available rentals</p>
            </div>
          </Link>
        </div>
        <div className="col-md-6">
      ...
      {/* RECENT LISTINGS */}
      <h5 className="mb-3" style={{ color: 'var(--primary)', fontWeight: 'bold' }}>Recent Listings</h5>
          ...
          <div className="col-md-4 mb-4" key={property._id}>
            <div className="card shadow-sm" style={{ borderRadius: '12px', border: 'none' }}>
              ...
              <div className="card-body">
                ...
                <p style={{ color: 'var(--accent)', fontWeight: 'bold' }}>₦{property.price.toLocaleString()} / year</p>
                <Link
