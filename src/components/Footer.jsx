...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: 'var(--primary)', color: 'var(--white)', marginTop: '60px' }}>
        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            <div className="d-flex align-items-center gap-2 mb-3">
              <Logo />
              <span style={{ color: 'var(--accent)', fontSize: '1.3rem', fontWeight: 'bold' }}>
                Home<span style={{ color: 'var(--white)' }}>Find</span>
              </span>
            </div>
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem', lineHeight: '1.7' }}>
              Nigeria's trusted property rental and sales platform. Find your perfect home or list your property with ease.
            </p>
            {/* SOCIAL LINKS */}
            <div className="d-flex gap-3 mt-3">
              <a href="#" style={{ color: 'var(--accent)', fontSize: '1.3rem' }}>
                <FaFacebook />
              </a>
              <a href="#" style={{ color: 'var(--accent)', fontSize: '1.3rem' }}>
                <FaTwitter />
          ...
          <div className="col-md-2 mb-4">
            <h6 style={{ color: 'var(--accent)', fontWeight: 'bold', marginBottom: '16px' }}>
              Quick Links
            </h6>
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              {['Apartment', 'House', 'Duplex', 'Studio', 'Self Contain'].map((type) => (
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li className="mb-2" style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>
                📧 support@homefind.ng
              </li>
              <li className="mb-2" style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>
                📞 +234 816 606 2863
